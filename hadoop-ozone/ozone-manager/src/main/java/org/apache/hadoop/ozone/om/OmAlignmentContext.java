...
public class OmAlignmentContext implements AlignmentContext {
  ...
  OmAlignmentContext(OzoneManager ozoneManager) {
    ...
    for (Method method : OzoneManagerProtocol.class.getDeclaredMethods()) {
  ...
  public long receiveRequestState(RpcRequestHeaderProto header,
    ...
    // TODO: Handle if it's standalone (i.e. omRatisServer is null)
  ...
  public boolean isCoordinatedCall(String protocolName, String methodName) {
    return protocolName.equals(OzoneManagerProtocol.class.getCanonicalName())
