...
public final class OMRequestTestUtils {
  ...
  /**
   * Add multipart info entry to the multipartInfoTable for OBS/LEGACY bucket.
   * @throws Exception
   */
  ...
  /**
   * Add multipart info entry to the multipartInfoTable for FSO bucket.
   * @throws Exception
   */
  public static void addMultipartInfoToTableFSO(boolean addToCache,
      OmKeyInfo omKeyInfo, OmMultipartKeyInfo omMultipartKeyInfo,
      long trxnLogIndex, OMMetadataManager omMetadataManager)
      throws IOException {
    String ozoneDBKey = omMetadataManager.getMultipartKey(
